...
// configuration step. It creates a namespace called `cpp_startup`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_startup::cmake::project_name, cpp_startup::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_startup::cmake::project_version);
      return EXIT_SUCCESS;
    }
